...
public class FarmAnimal extends Animal implements Edible {
    ...
    public void beEaten() {
        if (this.weight <= 0.0) {
            System.out.println("Zwierzę " + this.name + " jest martwe i zepsute, nie będzie z niego dobrego obiadu");
        } else {
            this.weight = 0.0;
            System.out.println("Zwierzę " + this.name + " zostało zjedzone i było pyszne.");
        }
    }
}
